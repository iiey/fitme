...
def upgrade() -> None:
    ...
    with op.batch_alter_table("activity", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_activity_athlete_dedup", ["athlete_id", "dedup_key"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_activity_athlete_id"), ["athlete_id"], unique=False)
        batch_op.create_index(
            "ix_activity_athlete_start", ["athlete_id", "start_date_time"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("data", app.types.CompressedJSON(), nullable=False),
        sa.Column("created_on", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        "source_identity",
        sa.Column("source", sa.String(), nullable=False),
        sa.Column("source_athlete_id", sa.String(), nullable=False),
        sa.Column("athlete_id", sa.String(), nullable=False),
        sa.Column("created_on", sa.DateTime(), nullable=False),
        sa.Column("updated_on", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("source", "source_athlete_id"),
    )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("activity", schema=None) as batch_op:
        batch_op.drop_index("uq_activity_source_external")
        ...
        batch_op.drop_index("ix_activity_athlete_start")
        batch_op.drop_index(batch_op.f("ix_activity_athlete_id"))
        batch_op.drop_index("ix_activity_athlete_dedup")
